...
const routes: Routes = [
  { path: 'edit/:id', component: EmployeeSummerRequestsComponent, data: { configRouteKey: 'EmployeeRequests/SummerRequests' } },
  { path: 'SummerRequests', component: EmployeeSummerRequestsComponent }
  , {
